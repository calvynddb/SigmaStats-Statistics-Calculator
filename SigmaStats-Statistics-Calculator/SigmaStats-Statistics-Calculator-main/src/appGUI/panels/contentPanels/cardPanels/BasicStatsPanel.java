...
import appGUI.panels.contentPanels.basicStatsPanels.InputPanel;
...
public class BasicStatsPanel extends JPanel {
    public BasicStatsPanel() {
        ...
        Image logoImg = logoIcon.getImage().getScaledInstance(640, 210, Image.SCALE_AREA_AVERAGING);
        logoLabel.setIcon(new ImageIcon(logoImg));
        logoLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        chartAndInput.add(Box.createVerticalStrut(10)); // Top margin
        chartAndInput.add(logoLabel);
        chartAndInput.add(Box.createVerticalStrut(-10)); // Space below logo
